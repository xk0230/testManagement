											...
											<table class="table table-condensed table-bordered table-striped" style="width:97%;margin-top:7px;" >
												...
												<tbody>
													<tr class="odd gradeX" ng-repeat="item in vm.list">
														...
														<td>
															<button type="button" class="btn btn-small btn-success" ng-click="vm.edit(item.userId)">编辑</button>
															<button type="button" class="btn btn-small btn-success" ng-click="vm.userTrainList(item.userId)">培训</button>
															<button type="button" class="btn btn-small btn-success" ng-click="vm.userTransferPositionList(item.userId)">调岗/调薪</button>
															<button type="button" class="btn btn-small btn-success" ng-click="vm.userAttachmentList(item.userId)">附件</button>
															<button type="button" class="btn btn-small btn-success" ng-click="vm.bookHis(item.userId,'.outlet')">借书记录</button>
														</td>
													</tr>
												</tbody>
											</table>
