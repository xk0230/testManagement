					...
					<div class="span12">
						...
						<%-- 		<div class="row">
							...
							<!-- 	<div class="row">
								...
								<div class="row">
									<div class="span12">
										<div style="width:1134px;" ng-if="${adminUser.userId == 'admin' || (travel.status!='05' && travel.status!='03' && travel.status!='01')}">
											...
											<tbody>
												<tr class="odd gradeX" ng-repeat="item in vm.list" ng-switch="item.editMode" ng-class="item.status=='99' ? 'ScrapBackground' : ''" >
													...
													<td ng-switch-when="view">
														<a href="javascript:;" class="btn btn-xs  " ng-if="${adminUser.userId == 'admin'} || (item.status!='05' && item.status!='03' && item.status!='01')" ng-click="vm.editTravel(item,$index)" ><i class='icon-edit'></i></a>
														<a href="javascript:;" class="btn btn-xs btn-danger" ng-if="${adminUser.userId == 'admin'} || (item.status!='05' && item.status!='03' && item.status!='01')" ng-click="vm.scrap(item)" ><i class='icon-remove-sign'></i></a>
													</td>
