					...
					<div class="span12">
						<div class="widget">
							...
							<div class="widget-content" style="padding-bottom: 100px;">
								...
								<div class="row">
									<h3 class="panel-title span359"><i class="ec-pencil"></i>部门/岗位</h3>
								</div>
								...
								<!-- 相关经历/成就要求 -->
								<div class="row lineMargin">
									<h3 class="panel-title span359"><i class="ec-pencil"></i>相关经历/成就要求</h3>
								</div>
								<div class="row lineMargin">
									<div class="span359 form-group">
								...
								<!-- 技术/岗位要求 -->
								<div class="row lineMargin">
									<h3 class="panel-title span359"><i class="ec-pencil"></i>技术/岗位要求</h3>
								</div>
								<div class="row lineMargin">
									<div class="span359 form-group">
								...
								<!-- 胜任特征 -->
								<div class="row lineMargin">
									<h3 class="panel-title span359"><i class="ec-pencil"></i>胜任特征</h3>
								</div>
								<div class="row lineMargin">
								...
								<!-- 教育背景 -->
								<div class="row lineMargin">
									<h3 class="panel-title span359"><i class="ec-pencil"></i>教育背景</h3>
								</div>
								<div class="row lineMargin">
									<div class="span359 form-group">
