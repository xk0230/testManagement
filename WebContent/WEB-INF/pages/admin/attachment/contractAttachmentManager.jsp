									...
									<div class="span12">
										...
										<tbody>
											<tr class="odd gradeX" ng-repeat="item in vm.list">
												...
												<td>
													<button type="button" class="btn btn-small btn-success btn-support-ask" ng-click="vm.addAttachment(item.id,'.widget-content')" value="修改">修改</button>
													<button type="button" class="btn btn-small btn-danger btn-support-ask" ng-click="vm.delAttachment(item.id,'.widget-content')" value="删除">删除</button>
												</td>
