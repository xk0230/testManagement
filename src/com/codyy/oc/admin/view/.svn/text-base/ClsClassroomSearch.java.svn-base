...
public class ClsClassroomSearch {
	...
	private String implementationProgress;//安装进展
	
	private String isTrain;//培训状态
	
	private String isStart;//开课情况
	
	private String installDesc;
	
	private String updateDesc;
	
	private String isExplore;  //环境勘查
	...
	public void setIsExplore(String isExplore) {
